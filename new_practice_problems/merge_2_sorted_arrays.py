...
Use two pointers to keep track of the current position in each of the two sorted arrays.
Compare and Merge:

Compare the elements at the current positions in both arrays.
Add the smaller element to the merged array and move the pointer in that array.
